...
const ExpenseForm: React.FC<ExpenseFormProps> = ({ onSave, onCancel, currentMonth }) => {
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="casual">Despesa Avulsa</SelectItem>
                  <SelectItem value="monthly">Despesa Mensal</SelectItem>
